...
class PaymentProcessMobile extends StatefulWidget {
  final SubscriptionPlanEntity subscriptionPlanEntity;
  const PaymentProcessMobile({super.key, required this.subscriptionPlanEntity});

  @override
  State<PaymentProcessMobile> createState() => _PaymentProcessMobileState();
}

class _PaymentProcessMobileState extends State<PaymentProcessMobile> {
