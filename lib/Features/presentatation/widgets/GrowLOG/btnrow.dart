...
class BtnRow extends StatefulWidget {
  final String text;
  final String id;
  const BtnRow({super.key, required this.text, required this.id});

  @override
  State<BtnRow> createState() => _BtnRowState();
}

class _BtnRowState extends State<BtnRow> {
  int btn = 0;
  @override
  void initState() {
    super.initState();
